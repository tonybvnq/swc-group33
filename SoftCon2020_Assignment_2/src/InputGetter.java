...
public class InputGetter {
    public static String[] askPlacement(Ship ship) {
        ...
        while (!inputIsValid) {
            ...
            if (ycoordinates.indexOf(firstEntry.charAt(0))!=-1 && ycoordinates.indexOf(secondEntry.charAt(0))!=-1 && xcoordinates.indexOf(firstEntry.charAt(1))!=-1 && xcoordinates.indexOf(secondEntry.charAt(1))!=-1) {
                inputIsValid = true;
            } else {
                inputIsValid = false;
            }
